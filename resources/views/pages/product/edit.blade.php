...
@section('content')
    <div class="container mt-5">
        <h4 class="mb-5">Edit Product {{ $items->name }}</h4>
        <form action="{{ route('produk.update', $items->id) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="kode_product" class="form-control" value="{{ $items->kode_product }}"
                    id="kode_product" required>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="number" name="stok" class="form-control" value="{{ $items->stok }}" id="stok"
                    required>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="lokasi" class="form-control" id="lokasi " value="{{ $items->lokasi }}"
                    required>
            </div>
            <div class="mb-3">
